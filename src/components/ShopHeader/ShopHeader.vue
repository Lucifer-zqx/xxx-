<template>
        <div class="shop-header">
            <nav class="shop-nav" :style="{backgroundImage: `url(${shopInfo.bgImg})`}"> <a class="back" @click="$router.back()"> <i class="iconfont icon-arrow_left"></i> </a> </nav>
            <div class="shop-content"><img class="content-image"
                    :src="shopInfo.avatar">
                <div class="header-content" @click="isShowShopDetail = !isShowShopDetail">
                    <h2 class="content-title"> <span class="content-tag"> <span class="mini-tag">品牌</span></span> <span
                            class="content-name">{{shopInfo.name}}</span> <i class="content-icon"></i> </h2>
                    <div class="shop-message"> <span class="shop-message-detail">{{shopInfo.score}}</span> <span
                            class="shop-message-detail">月售 {{shopInfo.ratingCount}} 单</span> <span class="shop-message-detail"> {{shopInfo.description}} <span>约
                                {{shopInfo.deliveryTime}}
                                分钟</span> </span> <span class="shop-message-detail">距离 {{shopInfo.distance}}</span> </div>
                </div>
            </div>
            <div class="shop-header-discounts" v-if="shopInfo.supports" @click="isShowActivity = !isShowActivity">
                <div class="discounts-left">
                    <div class="activity" :class="colorArr[shopInfo.supports[0].type]">
                      <span class="content-tag"> 
                        <span class="mini-tag">{{shopInfo.supports[0].name}}</span>
                      </span> 
                      <span class="activity-content ellipsis">{{shopInfo.supports[0].content}}</span> </div>
                </div>
            ...
            <div class="activity-sheet" v-if='isShowActivity'>
                <div class="activity-sheet-content">
                    ...
                    <ul class="list">
                        <li class="activity-item " v-for="support,index in shopInfo.supports" :key="index" :class="colorArr[support.type]"> 
