...
export const reqOnceCaptcha = () => ajax(BASE_URL+'/captcha')

// 6、用户名密码登陆](#6用户名密码登陆)
export const reqLoginWithName = ({name,pwd,captcha}) => ajax(BASE_URL+'/login_pwd',{name,pwd,captcha},"POST")

// 7、发送短信验证码](#7发送短信验证码)
export const reqCaptcha = phone => ajax(BASE_URL+'/sendcode',{phone})

// 8、手机号验证码登陆](#8手机号验证码登陆)
export const reqLoginWithCaptcha = (phone,code) => ajax(BASE_URL+'/login_sms',{phone,code},"POST")
